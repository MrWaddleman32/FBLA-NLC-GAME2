...
public class Question_and_answerScript : MonoBehaviour
{
    ...
    public SpriteRenderer lever1Sprite;
    public GameObject lever2;
    public SpriteRenderer lever2Sprite;
...
/*            for (int i = 0;i < Answers.GetLength(0); i++)
    ...
    public void ClickedCorrectAnswer()
    {
        ...
        else
        {
            ...
            StartCoroutine(setQuestionBackAfterGettingWrong());
        }
    ...
    IEnumerator setQuestionBackAfterGettingWrong()
    {
        yield return new WaitForSeconds(1);
        questionText.text = question;
    }

    public IEnumerator ExitQuestionPanel()
    {
        ...
        else
        {
            ...
            {
                if (boxCollider.ToString().Equals("Lever1 (UnityEngine.BoxCollider2D)"))
                {
                    lever1.transform.LeanScaleX(-.22f, .2f);
                    lever1Sprite.color = Color.green;
                }
                if (boxCollider.ToString().Equals("Lever2 (UnityEngine.BoxCollider2D)"))
                {
                    lever2.transform.LeanScaleX(-.22f, .2f);
                    lever2Sprite.color = Color.green;
                }
            }
            questionNum = 1;
            numOfQuestion = 1;
